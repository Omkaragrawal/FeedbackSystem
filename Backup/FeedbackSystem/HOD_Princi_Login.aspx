<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="HOD_Princi_Login.aspx.cs" Inherits="FeedbackSystem.HOD_Princi_Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>HOD / Principal <span>Login</span></h2>
    <form id="contactsform" runat="server" class="loginform">
        <fieldset>
            ...
            <div>
                ...
                <asp:Button runat="server" CausesValidation="false" ID="btnStdLogin" class="formbutton" Text="Submit" ForeColor="White"  OnClick="btnStdLogin_Click" />
                <%--<div style="text-align: center; margin-right: 30px;">Don't have account?&nbsp;&nbsp;<a href="FacultySignUp.aspx">Sign Up!</a></div>--%>
                <br />
