...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="contactsform" action="#" runat="server">
        <fieldset>
            <ul>
                <li style="height: 190px; width:60%;"><strong>Question 6: [Max Marks 5]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ6Ans" runat="server" CssClass="textBoxStyle" Width="555px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:TextBox ID="txtQ6Marks" runat="server"  CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtQ6Marks">*</asp:RequiredFieldValidator>
                </li>
                ...
                <li style="height: 400px; width:60%;"><strong>Question 7: [Max Marks 25]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ7Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtQ7Marks">*</asp:RequiredFieldValidator>
                </li>
                ...
                <li style="height: 290px; width:60%;"><strong>Question 8: [Max. Marks 10]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ8Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtQ8Marks">*</asp:RequiredFieldValidator>
                </li>
                ...
                <li style="height: 280px; width:60%"><strong>Question 9: [Max. Marks 10]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ9Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtQ9Marks">*</asp:RequiredFieldValidator>
                </li>
                ...
                <li style="height: 270px; width:60%"><strong>Question 10: [Max. Marks 10]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ10Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtQ10Marks">*</asp:RequiredFieldValidator>
                </li>
                ...
                <li style="height: 125px;"><strong>Question 11: [Max Marks 20]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ11Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtQ11Marks">*</asp:RequiredFieldValidator>
                </li>
                ...
                <li style="height: 125px;"><strong>Question 12: [Max Marks 10]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ12Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                ...
                <li style="height: 125px;"><strong>Question 13: [Max Marks 5]</strong><br />
                    ...
                    <asp:TextBox ID="txtQ13Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtQ11Marks">*</asp:RequiredFieldValidator>
                </li>

                <li style="height: 185px; width:60%"><strong>Question 14: [Max Marks 5]</strong><br />
                    ...
                    <br />
                    <asp:TextBox ID="txtQ14Marks" runat="server" CssClass="textBoxStyle" Width="50px" Height="50px" TextMode="MultiLine"></asp:TextBox>
            ...
            <asp:Button Style="margin-left: 0%;" runat="server" ID="btnSubmit" class="formbutton" Text="Submit" ForeColor="White" OnClick="btnContinue_Click" />
