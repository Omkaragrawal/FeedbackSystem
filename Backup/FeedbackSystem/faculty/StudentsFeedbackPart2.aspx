<%@ Page Title="" Language="C#" MasterPageFile="~/faculty/FacultyMaster.Master" AutoEventWireup="true" CodeBehind="StudentsFeedbackPart2.aspx.cs" Inherits="FeedbackSystem.faculty.StudentsFeedbackPart2" %>
        ...
        <fieldset>
            <ul style="line-break: auto;">
               <li style="height: 50px;">1. Knowledge related to the Subject (Theory / Practical)<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                ...
                <li style="height: 70px;">11. Coverage of Theory Syllabus / Practicals<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server"
                ...
                <li style="height: 50px;">15. Opportunity for asking Questions in Classroom / Laboratory / Staff  room <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server"
                ...
                <li style="height: 80px;">20. Threatening in or outside Classroom / Laboratory / Staff room / forces for Personal & Paid Tution at his residence or outside college premises <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server"
                ...
                <li style="height: 125px;"><strong>suggestion:</strong><br />
                    Any Other Suggestion:<br />
                    <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBoxStyle" Width="550px" Height="50px" TextMode="MultiLine"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server"
                        ErrorMessage="" Font-Size="Large" ControlToValidate="txtRemarks">*</asp:RequiredFieldValidator>
                </li>
            </ul>


            <asp:Button Style="margin-left: 0%;" runat="server" ID="btnSubmit" class="formbutton" Text="Submit" ForeColor="White"  />
