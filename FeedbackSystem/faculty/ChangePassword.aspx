<%@ Page Title="" Language="C#" MasterPageFile="~/faculty/FacultyMaster.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="FeedbackSystem.faculty.ChangePassword" %>
        ...
        <fieldset>
            ...
            <div class="field">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                    ErrorMessage="" ControlToValidate="txtnewpwd">*</asp:RequiredFieldValidator>
            </div>
            <br />
            <div class="field">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                    ErrorMessage="" ControlToValidate="txtconfpwd">*</asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage=""
                    ControlToValidate="txtconfpwd" ControlToCompare="txtnewpwd">
                    Password not maching!
                </asp:CompareValidator>
            </div>
            <br />
            <div style="text-align: center; margin-right: 35px;">
                <asp:Button runat="server" ID="btnUpdatePwd" class="formbutton" Text="Update Password" OnClick="btnUpdatePwd_Click" />
            </div>
        </fieldset>
    </form>
    <%--<div class="address">
