<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UpdateDeleteStudent.aspx.cs" Inherits="FeedbackSystem.admin.UpdateDeleteStudent" %>
    ...
    <form id="contactsform" action="#" runat="server">
        <fieldset>
            ...
            <div style="text-align: center">
                <asp:Button ID="btnUpdateStudent" runat="server" Visible="false" Text="Update Student!" class="formbutton" OnClick="btnUpdateStudent_Click" />
                <asp:Button ID="btnDeleteStudent" runat="server" Visible="false" Text="Delete Student!" class="formbutton" OnClick="btnDeleteStudent_Click"  />
